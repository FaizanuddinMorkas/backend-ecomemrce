...
var bcrypt_1 = __importDefault(require("bcrypt")); // Ensure you import bcrypt if you're hashing passwords
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, newUser]; // Optionally return the new user
            case 4:
                error_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, token]; // Or return the token
        }
    });
}); };
exports.login = login;
