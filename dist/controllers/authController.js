...
var authService_1 = require("../services/authService"); // Adjust import as necessary
// Register user
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, authService_1.register)(username, password)];
            case 1:
                newUser = _b.sent();
                if (!newUser) {
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, password = _a.password;
                return [4 /*yield*/, (0, authService_1.login)(username, password)];
            case 1:
                token = _b.sent();
                if (!token) {
